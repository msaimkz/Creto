...
<form class="form" id="FeedBackForm" name="FeedBackForm" method="post">
    ...
    <div class="service-input">
        <div>
            <input type="text" placeholder="Name" class="dark-input-service form-control" name="name" id="name"
                autocomplete="off">
            <span></span>
        </div>
        <div>
            <input type="email" placeholder="Email" class="dark-input-service form-control" name="email" id="email"
                autocomplete="off">
            <span></span>
        </div>
