            ...
            <div class="Product-button">
                @if ($product->qty != 0)
                    <a href="javascript:void(0)" onclick="AddtoCart('{{ $product->id }}')"
                        class="cart-button gear-button">Add To
                        cart </a>
                @else
    ...
    <div class="Product-comment-container">
                ...
                @if (!empty($ratings))
                    @foreach ($ratings as $rating)
                        <div class="comment-content">
                            ...
                            <span
                                class="nav-nigth">{{ \Carbon\Carbon::parse($rating->created_at)->format('M d, Y') }}</span>
        ...
        <form action="" class="form" method="post" id="RatingForm" name="RatingForm">
            ...
            <div class="service-input comment-input">
                <div>
                    <input type="text" placeholder="Name" class="dark-input-service form-control" id="name"
                        name="name">
                    <span></span>
                </div>
                <div>
                    <input type="email" placeholder="Email" class="dark-input-service form-control" id="email"
                        name="email">
                    <span></span>
                </div>
            </div>
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        ...
                        <div class="fourth-card">
                            ...
                            <div class="fourth-content-box card-dark">
                                ...
                                <a class="gear-button" href="{{ route('Product', $relatedProduct->slug) }}"><span>View
                                        More</span></a>
                            </div>
                        </div>
                    @endforeach
