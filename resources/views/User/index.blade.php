    ...
    <div class="swiper-wrapper">
        <div class="swiper-slide dark-slider" id="slide-1">
            <div class="content-box">
                ...
                <p class="nav-nigth">Ride with confidence on the best bikes, engineered for performance, comfort, and style.</p>
...
<div class="second-section">
    ...
    <div class="card dark-card">
        <div class="card-content" style="background-image: url('{{ asset("uploads/Service/thumb/{$service->img}") }}');">
            <h1 class="nav-nigth">{{$service->title}}</h1>
            <a href="{{route('Service-Detail',$service->slug)}}" class="gear-button service-button">View More</a>
        </div>
    </div>
    ...
    <div class="sixth-card-container">
        ...
        <div class="sixth-card">
            ...
            <div class="sixth-content-box card-dark">
                ...
                <a class="gear-button" href="{{route('Product',$TopProduct->slug)}}"><span>View More</span></a>
            </div>
        </div>
        @endforeach
        @else
...
<!-- javascript link  -->
<script>
    var couponCode = "{{ (!empty($coupon->expire_at) ? \Carbon\Carbon::parse($coupon->expire_at)->format('M d, Y h:i:s') : 'Aug 30, 2024 12:33:23')}}";
