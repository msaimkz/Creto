                    ...
                    <div class="card cart-summery">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between summery-end">
                                ...
                                <div class="h5 nav-nigth"><strong id="discount">${{number_format($discount,2)}}</strong></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2">
                                <div class="h6 nav-nigth"><strong>Shipping</strong></div>
                                <div class="h5 nav-nigth"><strong id="shipping">${{number_format($shippingcharges,2)}}</strong>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between mt-2 summery-end">
                                <div class="h6 nav-nigth"><strong>Total</strong></div>
                                <div class="h5 nav-nigth"><strong id="grand-total">$ {{ number_format($grandtotal ,2) }}</strong>
                                </div>
                            </div>
                        </div>
                    </div>
...
$('#discount-button').click(function() {
    $.ajax({
        ...
        success: function(response) {
            if (response.status == true) {
                console.log(response.discountString)
                $('#shipping').html('$' + response.ShippingCharges)
