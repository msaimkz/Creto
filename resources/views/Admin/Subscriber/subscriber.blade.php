                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($subcriber->created_at)->format('Y-M-d') }}</td>

                                <td>

                                    <a href="{{ route('Show-Subscriber',$subcriber->id) }}"
                                    ...
                                    <a href="javascript:void(0)" class="text-danger w-4 h-4 mr-1"
                                        onclick="deleteSubscriber('{{ $subcriber->id }}')">
...
function deleteSubscriber(id) {
    var url = '{{route("Delete-Subscriber","ID")}}';
    ...
    if (confirm('Are You sure want to delete')) {
        $.ajax({
            ...
            success: function(response) {
                if (response['status']) {
                    window.location.href = '{{route("Subscribers")}}'
