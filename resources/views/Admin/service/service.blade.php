            ...
            <div class="container-fluid my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ route('Create-Service') }}" class="btn btn-primary">New Service</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
                ...
                <div class="card">
                    <form action="" method="get">
                        <div class="card-header">
                            <a href="{{ route('Admin-service') }}" class="btn btn-primary">Reset</a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response['status'] == true) {
                            $(`#service-row-${response['id']}`).remove()
