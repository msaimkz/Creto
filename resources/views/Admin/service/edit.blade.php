                    ...
                    <div class="row">
                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" readonly name="slug" id="slug"
                                                    class="form-control" placeholder="slug" value="{{ $service->slug }}">
                                                <p class="error"></p>
                                            </div>
                            ...
                            @if (!empty($service->img))
                                <div class="col-md-3">
                                    <div class="card">
                                        <input type="hidden" name="img_array" value="{{ $service->id }}">
                                        <img src="{{ asset('uploads/Service/thumb/' . $service->img) }}" class="card-img-top"
                                            alt="...">
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <select name="is_Home" id="is_Home" class="form-control">
                                            <option value="No" {{ $service->is_Home == 'No' ? 'selected' : '' }}>No
                                            </option>
                                            <option value="Yes" {{ $service->is_Home == 'Yes' ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                        <p class="error"></p>
                                    </div>
...
@section('js')
    ...
    <script>
        ...
        $('#ServiceForm').submit(function(event) {
            ...
            $('button[type=submit]').prop('disabled', true)
            $.ajax({
                url: '{{ route('Update-Service', $service->id) }}',
                type: 'post',
