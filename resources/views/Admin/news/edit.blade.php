                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" readonly name="slug" id="slug"
                                                    class="form-control" placeholder="slug" value="{{ $news->slug }}">
                                                <p class="error"></p>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="0" {{ $news->status == 0 ? 'selected' : '' }}>Block
                                            </option>
                                        </select>
                                        <p class="error"></p>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <select name="is_Home" id="is_Home" class="form-control">
                                            <option value="No" {{ $news->is_Home == 'No' ? 'selected' : '' }}>No
                                            </option>
                                            <option value="Yes" {{ $news->is_Home == 'Yes' ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                        <p class="error"></p>
                                    </div>
